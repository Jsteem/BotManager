...
public class BotModule extends AbstractModule {
    ...
    public BotModule(OkHttpClient okHttpClient, Supplier<Applet> clientLoader,
                     RuntimeConfigLoader configSupplier, boolean developerMode,
                     boolean safeMode, File sessionfile, File config, String login,
                     String password, String startScript, Boolean isMember) {
    ...
    protected void configure()
    {
        ...
        if (runtimeConfig != null && runtimeConfig.getProps() != null)
        {
            ...
            bindConstant().annotatedWith(Names.named("login")).to(login);
            bindConstant().annotatedWith(Names.named("password")).to(password);
            bindConstant().annotatedWith(Names.named("isMember")).to(isMember);
            bindConstant().annotatedWith(Names.named("startScript")).to(startScript);
