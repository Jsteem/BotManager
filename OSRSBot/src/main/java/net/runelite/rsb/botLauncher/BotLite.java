...
import net.runelite.client.modified.BotModule;
...
public class BotLite extends RuneLite implements BotLiteInterface {
    ...
    public BotLite() throws Exception {
        ...
        Executors.newSingleThreadScheduledExecutor().submit(() -> {
            ...
            methods.account.setLogin(injector.getInstance(Key.get(String.class, Names.named("login"))));
            methods.account.setStartScript(injector.getInstance(Key.get(String.class, Names.named("startScript"))));
            methods.account.setPassword(injector.getInstance(Key.get(String.class, Names.named("password"))));
            methods.account.setIsMember(injector.getInstance(Key.get(Boolean.class, Names.named("isMember"))));
